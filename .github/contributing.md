...
No extra work is required here as it is [already integrated by the way of GitHub actions](https://github.com/ian-jane/awesome-falsehood/tree/main/.github/workflows).
