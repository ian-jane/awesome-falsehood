...
这里不需要额外的工作，因为它已经 [通过 GitHub actions 集成](https://github.com/ian-jane/awesome-falsehood/tree/main/.github/workflows)。
...
另见 [为什么我的开源项目被删除了？](#为什么我的开源项目被删除了)，了解 open-core-heavy 模式 — 即使项目在技术上是开源的，该模式也适用。
...
另见 [为什么我的商业项目不在列表中？](#为什么我的商业项目不在列表中)，了解完全付费墙、不存在开源发行版的情况。

### 为什么我的项目因不活跃而被删除？

除了 [已存档的仓库](#为什么删除不活跃的-github-项目) 之外，我们还会删除作者已正式退役的项目：README 中将用户指向其他项目的通知，或者"新项目不应再依赖此项目"的公开声明，被视为比单独的 GitHub 存档标志更强的信号。
